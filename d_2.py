...
class Divide():                            
    def __init__(self,pdbname1=None,pdbname2=None):
        ...
        self.todivide=np.load(f"/home/yuyue/evomatrix/evo/record/strategy0/{pdbname1}_37_data.npy")
        ...
        for i in range(part_len):
            for j in range(i+1,part_len):
                tochioce=self.toChioce(self.todivide[i,j],threhold=0.01)
                print(i,j,tochioce)
    ...
    def toChioce(self,todiv,threhold=None): #list
        if threhold==None: threhold=1 # 有点大
